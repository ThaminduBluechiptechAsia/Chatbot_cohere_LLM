...
img = Image.open('E:\Officeworks\Chatbot_cohere_LLM\static\images\logo.png')
...
with st.sidebar:
    ...
    sidebar_image = Image.open('E:/Officeworks/Chatbot_cohere_LLM/static//images/logo.png')
